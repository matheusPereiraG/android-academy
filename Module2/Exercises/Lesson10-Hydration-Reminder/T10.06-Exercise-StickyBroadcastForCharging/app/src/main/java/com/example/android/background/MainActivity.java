...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            showCharging(btManager.isCharging());
        }
        else {
            IntentFilter sticky = new IntentFilter();
            sticky.addAction(Intent.ACTION_BATTERY_CHANGED);
            Intent intent = registerReceiver(null, sticky);
            int info = intent.getIntExtra(BatteryManager.EXTRA_STATUS, BatteryManager.BATTERY_STATUS_NOT_CHARGING);
            showCharging(info == BatteryManager.BATTERY_STATUS_CHARGING || info == BatteryManager.BATTERY_STATUS_FULL);
        }
