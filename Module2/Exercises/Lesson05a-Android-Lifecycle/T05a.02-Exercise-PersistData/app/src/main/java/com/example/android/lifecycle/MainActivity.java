...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "123";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String displayStr = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, displayStr);
    }
