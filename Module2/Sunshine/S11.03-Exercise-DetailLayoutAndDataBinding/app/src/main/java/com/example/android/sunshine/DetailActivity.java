...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDetailBinding.extraWeatherInfo.humidity.setText(humidityString);
        mDetailBinding.extraWeatherInfo.humidity.setContentDescription(humidityA11y);

        mDetailBinding.extraWeatherInfo.humidityLabel.setContentDescription(humidityA11y);
        ...
        mDetailBinding.extraWeatherInfo.windMeasurement.setText(windString);
        mDetailBinding.extraWeatherInfo.windMeasurement.setContentDescription(windA11y);

        mDetailBinding.extraWeatherInfo.windLabel.setContentDescription(windA11y);
        ...
        mDetailBinding.extraWeatherInfo.pressure.setText(pressureString);
        mDetailBinding.extraWeatherInfo.pressure.setContentDescription(pressureA11y);

        mDetailBinding.extraWeatherInfo.pressureLabel.setContentDescription(pressureA11y);
